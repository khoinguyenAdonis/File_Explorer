...
MenuBar {
    ...
    delegate: MenuBarItem {
        ...
        background: Rectangle {
            ...
            color: /*menuBarItem.highlighted ? Colors.selection : "transparent"*/ "white"
            Rectangle {
                id: indicator
            ...
            Rectangle {
                id: bottomBorder1
                width: parent.width // Chiều rộng bằng với Rectangle cha
                height: 1           // Độ dày của đường viền
                color: "darkblue"       // Màu của đường viền
                anchors.bottom: parent.bottom // Căn chỉnh xuống đáy của Rectangle cha
        ...
        RowLayout {
            ...
            InteractionButton {
                ...
                Rectangle {
                    ...
                    color: /*parent.hovered ? Colors.iconIndicator : Colors.icon*/ "black"
                    height: 2
